...
public class TelefoneView implements GenericView<Telefone>{
    ...
    public TelefoneView(EntityManager em) {
        this.em = em;
        this.controller = new TelefoneController(em);
    }
    ...
    public void adicionar(Scanner input) {
        ...
        this.controller.salvar(novoTelefone);
    }
    ...
    public void listarTodos() {
        ArrayList <Telefone> result = this.controller.listarTodos();
    ...
    private void consultarPorNumero(Scanner inp) {
        ...
        ArrayList <Telefone> result = this.controller.findByNumero(num);
        printarResultado(result);
    }
    ...
    private void consultarPorGrupo(Scanner inp) {
        ...
        ArrayList <Telefone> result = this.controller.findByGrupo(desc);
        printarResultado(result);
    }
    ...
    private void consultarPorContato(Scanner inp) {
        ...
        ArrayList <Telefone> result = this.controller.findByContato(nome);
        printarResultado(result);
    }
