...
public class GrupoView implements GenericView<Grupo>{
    ...
    public GrupoView(EntityManager em) {
        this.em = em;
        this.controller = new GrupoController(em);
    }
    ...
    public void adicionar(Scanner input) {
        ...
        Grupo novoGrupo = new Grupo(descricao);
        this.controller.salvar(novoGrupo);
    }
    ...
    public void listarTodos() {
        ArrayList <Grupo> result = this.controller.listarTodos();
    ...
    private void consultarPorDescricao(Scanner inp) {
        ...
        ArrayList <Grupo> result = this.controller.findByDescricao(desc);
        printarResultado(result);
    }
    ...
    private void consultarPorTelefone(Scanner inp) {
        ...
        ArrayList <Grupo> result = this.controller.findByNumero(num);
        printarResultado(result);
    }
    ...
    private void consultarPorContato(Scanner inp) {
        ...
        ArrayList <Grupo> result = this.controller.findByContato(nome);
        printarResultado(result);
    }
